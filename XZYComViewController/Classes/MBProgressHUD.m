...
//	CGSize labelSize = MB_TEXTSIZE(label.text, label.font);
    CGSize labelSize = MB_MULTILINE_TEXTSIZE(label.text, label.font,CGSizeMake(maxWidth, bounds.size.height - totalSize.height - kPadding - 4 * margin),label.lineBreakMode);
