Pod::Spec.new do |s|
  ...
  s.description  = "自己封装的UIViewController"  #描述
  ...
  s.source       = { :git => "https://github.com/740238622/XZYComViewController.git", :tag => "1.0.1" }         #存储库的git地址，以及tag值
  s.source_files = "XZYComViewController/Classes/**/*.{h,m}" #需要托管的源代码路径
  s.source_files = "XZYComViewController/Classes/**/*.png"
