Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/740238622/XZYComViewController.git", :tag => "1.5.5" }         #存储库的git地址，以及tag值
  s.source_files = "XZYComViewController/Classes/**/*.{h,m}" #需要托管的源代码路径
  s.resources    = "XZYComViewController/Classes/**/*.{png,gif}"
  # s.resources    = "XZYComViewController/Classes/**/*.gif"
